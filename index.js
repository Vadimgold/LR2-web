...
const calcButton = document.getElementById("CalculateB");
const calcSolution = document.getElementById("CalculatorS1");
const calcSolution2 = document.getElementById("CalculatorS2");
const contribution = document.getElementById("CalculatorContr");
...
const calculateTerm = () => {
    ...
    if (contribution.value) {
        if (contribution.value <= 0) {
            calcSolution2.innerHTML = "<p style='color: red'> Введите правильную сумму!</p>"
        } else {
